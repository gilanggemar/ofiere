...
echo "║   Env:     $ENV_FILE"
echo "║                                                      ║"
echo "║   10 Meta-tools available to ALL agents:             ║"
echo "║     • OFIERE_TASK_OPS          (tasks + exec plans)  ║"
echo "║     • OFIERE_AGENT_OPS         (list agents)         ║"
echo "║     • OFIERE_PROJECT_OPS       (spaces/folders/deps) ║"
echo "║     • OFIERE_SCHEDULE_OPS      (calendar events)     ║"
echo "║     • OFIERE_KNOWLEDGE_OPS     (knowledge library)   ║"
echo "║     • OFIERE_WORKFLOW_OPS      (16 node types)       ║"
echo "║     • OFIERE_NOTIFY_OPS        (notifications)       ║"
echo "║     • OFIERE_MEMORY_OPS        (conversations)       ║"
echo "║     • OFIERE_PROMPT_OPS        (prompt chunks)       ║"
echo "║     • OFIERE_CONSTELLATION_OPS (agent architecture)  ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""
