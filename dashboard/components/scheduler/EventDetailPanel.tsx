        ...
        <AnimatePresence>
            {selectedEventId && (
                <motion.div
                    ...
                    className="nerv-glass-3 border-t border-white/[0.08] p-6 max-h-[40vh] overflow-y-auto"
                >
                    {/* ─── Top bar ─── */}
                    <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                            <Input
                                ...
                                className="nerv-h2 bg-transparent border-none px-0 h-auto focus-visible:ring-0 font-semibold text-[var(--text-primary)]"
                            />
                        </div>
                        <div className="flex items-center gap-2 ml-4">
                            {(() => {
                                const agent = agents.find((a: any) => a.id === event.agentId);
                                return agent ? <span className="nerv-body-sm opacity-70">{agent.name}</span> : null;
                            })()}
                            <AlertDialog>
                                ...
                                <AlertDialogContent className="nerv-glass-3">
                                    <AlertDialogHeader>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        {/* ─── Schedule section ─── */}
                        <div>
                            <h4 className="nerv-section mb-3 flex items-center gap-1.5">
                                <Calendar className="w-3.5 h-3.5" /> Schedule
                            </h4>
                            <div className="grid grid-cols-3 gap-2">
                                <div>
                                    <label className="nerv-caption mb-1 block">Date</label>
                                    <Input
                                        type="date"
                                        value={scheduledDate}
                                ...
                                <div>
                                    <label className="nerv-caption mb-1 block">Time</label>
                                    <Input
                                        type="time"
                                        value={scheduledTime}
                                ...
                                <div>
                                    <label className="nerv-caption mb-1 block">Duration</label>
                                    <Input
                                        type="number"
                    ...
                    {event.runCount > 0 && (
                        <div className="mt-4 border-t border-white/[0.06] pt-3">
                            <h4 className="nerv-section mb-2">Execution History</h4>
                            <div className="nerv-caption space-y-1">
                                <div className="flex items-center gap-2">
