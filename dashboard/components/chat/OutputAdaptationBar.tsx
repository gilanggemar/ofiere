...
export const OutputAdaptationBar: React.FC<OutputAdaptationBarProps> = ({
    ...
    return (
        ...
        >
            {isAdapting && <Loader2 className="w-3 h-3 animate-spin" style={{ color: 'var(--nerv-text-ghost)' }} />}
            ...
            <div className="relative">
                <button
                    ...
                    style={{
                        ...
                        background: showAudience ? 'var(--nerv-surface-4)' : 'transparent',
                    }}
                    onMouseEnter={e => (e.currentTarget.style.color = 'var(--nerv-text-secondary)')}
                    onMouseLeave={e => (e.currentTarget.style.color = 'var(--nerv-text-ghost)')}
                >
            ...
            <div className="relative">
                <button
                    ...
                    style={{
                        color: 'var(--nerv-text-ghost)',
                        background: showTone ? 'var(--nerv-surface-4)' : 'transparent',
                    }}
                    onMouseEnter={e => (e.currentTarget.style.color = 'var(--nerv-text-secondary)')}
                    onMouseLeave={e => (e.currentTarget.style.color = 'var(--nerv-text-ghost)')}
                >
