...
export function CommandHeader() {
    ...
    return (
        <div className="w-full h-14 nerv-glass-1 border-b border-border/40 flex items-center justify-between px-6 sticky top-0 z-40">
            <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-accent/20 border border-accent/40 flex items-center justify-center nerv-glow-border">
                    <Zap size={16} className="text-accent" />
                </div>
                <div className="flex items-baseline gap-2">
                    <span className="text-xs text-muted-foreground uppercase tracking-widest font-semibold">Fleet Power</span>
                    <motion.span className="nerv-power-score text-2xl relative">
                        {count}
                    </motion.span>
                </div>
            </div>
            ...
            <div className="flex items-center">
                <span className="nerv-mono text-muted-foreground/80 text-[11px] tracking-wider">
                    {timeStr}
                </span>
            </div>
        </div>
